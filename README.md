...
Из-за того, что на некоторые endpoint нет доступа и данные не получить, понадобится использование  не всех таблиц, поэтому совсем неиспользуемые таблицы в dds, cdm и часть dags были очищены.